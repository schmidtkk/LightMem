...
- [x] **v0.3.2** — Dual Codex CLI + Claude Code plugin metadata, AGENTS.md gateway, 22 doctor checks, Codex rollout transcript parsing.
...
- [x] **v0.3.2** —— Codex CLI + Claude Code 双插件元数据、AGENTS.md gateway、22 项 doctor 检查、Codex rollout transcript 解析。
